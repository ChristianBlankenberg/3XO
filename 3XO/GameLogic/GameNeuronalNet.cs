...
namespace TicTacToe.GameLogic
{
    internal class GameNeuronalNet
    {
        ...
        internal Coordinates GetOutput(Board<PlayerComputer> board)
        {
        ...
        private double[] GetInputLayer(Board<PlayerComputer> board) => board.Fields().Select(b => b.AsDouble()).ToArray();
